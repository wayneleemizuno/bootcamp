public class Week1Revision {
  public static void main(String[] args) {
    ...
    // ! else if -> If you are beginner, strongly recommand not to write complicated
    // condition in "else if"
    double price = 99.99;
    int quantity = 10;
    ...
    if (oddSum > evenSum) {
      System.out.println("The sum of odd numbers is larger.");
    } else {
      System.out.println("The sum of even number is larger");
    }
